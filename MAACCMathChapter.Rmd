...
We use the **tidyverse** collection of packages developed by RStudio, and specifically **ggplot2** for visualizations and **dplyr** for data analysis, [@wickham2021a;@wickham2021]. We also use the **png** package for reading and manipulating png images, and the **knitr** package for printing tables and including graphics. 
